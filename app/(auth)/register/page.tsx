  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 py-10 md:py-20 max-w-lg px-4 sm:px-0 mx-auto w-full">
        <Card className="light max-w-lg px-6 py-8 sm:p-12 relative rounded-2xl border-zinc-200 bg-white shadow-2xl shadow-zinc-950/10">
              ...
              <FieldGroup className="gap-6">
                ...
                <Field className="gap-4">
                  <Button
                    type="submit"
                    size={"lg"}
                    className="rounded-full cursor-pointer h-10 bg-zinc-950 text-white hover:bg-zinc-800 shadow-md shadow-zinc-950/10"
                  >
                    Sign up
                  </Button>
